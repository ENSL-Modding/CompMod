...
function Commander:GetCommHealthBarsShown()
...
function Commander:AddGhostGuide(origin, radius)
    ...
    local guide = table.remove(self.reuseGhostGuides)
...
function Commander:OnInitLocalClient()
    ...
    self.commHealthBars = Client.GetOptionBoolean("commanderHealthBars", false)
