...
function GUIRegenerationFeedback:Initialize()
    ...
    bottomLeftCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIRegenerationFeedback.kCornerTextureCoordinates.BottomLeft))
    ...
    bottomRightCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIRegenerationFeedback.kCornerTextureCoordinates.BottomRight))
