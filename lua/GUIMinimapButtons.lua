...
function GUIMinimapButtons:Initialize()
    ...
    self.pingButton:SetTexturePixelCoordinates(GUIUnpackCoords(GetTextureCoordinatesForIcon(kTechId.PingLocation)))
    ...
    self.techMapButton:SetTexturePixelCoordinates(GUIUnpackCoords(GetTextureCoordinatesForIcon(kTechId.Research)))
