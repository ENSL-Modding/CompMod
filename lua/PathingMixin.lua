...
function PathingMixin:__initmixin()
    ...
    PROFILE("PathingMixin:__initmixin")
...
function PathingMixin:SmoothTurn(time, direction, moveSpeed)
    ...
    local angles = self:GetSpeedLimitAngles()
    local maxSpeedAngle, minSpeedAngle = angles[1], angles[2]
...
function PathingMixin:SetCurrentPositionValid(_)
