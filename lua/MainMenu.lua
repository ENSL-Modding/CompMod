...
function MainMenu_HostGame(mapFileName, _, hidden)
    ...
    if Client.StartServer(mapFileName, serverName, password, port, maxPlayers, false, hidden) then
        LeaveMenu()
    end
...
function MainMenu_GetMenuBackgrounds()
    local menus = { "Default", "Unearthed", "Derelict", "Eclipse", "Kodiak", "Biodome", "Descent", "Docking", "Mineshaft", "Refinery", "Summit", "Tram", "Veil", "Caged", "Random" }
    return menus
end
