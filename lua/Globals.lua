...
kSandstormHMGItemId = kSandstormRifleItemId
...
kHMGVariant = enum({ "normal", "sandstorm" })
kHMGVariantData =
{
    [kHMGVariant.normal] =
    {
...
kDefaultHMGVariant = kHMGVariant.normal


kMarineStructureVariants = enum({ 'Default', 'Sandstorm' })
kAlienStructureVariants = enum({ 'Default', 'Toxin', 'Unearthed' })
...
kAlienStructureVariantsData =
{
    ...
    [ kAlienStructureVariants.Unearthed ] = { itemId = kUnearthedCommanderItemId, displayName = "Unearthed" },
}
...
kAlienTunnelVariants = enum({ 'Default', 'Shadow', 'Toxin', 'Unearthed' })

kAlienTunnelVariantsData =
{
    [ kAlienTunnelVariants.Default ] = { modelFilePart = "",displayName = "Normal" },
    [ kAlienTunnelVariants.Shadow ] = { itemId = kShadowGorgeItemId, modelFilePart = "_shadow", displayName = "Shadow" },
    [ kAlienTunnelVariants.Toxin ] = { itemId = kToxinSkulkItemId, modelFilePart = "", displayName = "Toxin" },
    [ kAlienTunnelVariants.Unearthed ] = { itemId = kUnearthedCommanderItemId, modelFilePart = "", displayName = "Unearthed" },
}
