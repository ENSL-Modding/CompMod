...
function GUIXenocideFeedback:_InitializeCorners()
    ...
    topLeftCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIXenocideFeedback.kCornerTextureCoordinates.TopLeft))
    ...
    bottomLeftCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIXenocideFeedback.kCornerTextureCoordinates.BottomLeft))
    ...
    topRightCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIXenocideFeedback.kCornerTextureCoordinates.TopRight))
    ...
    bottomRightCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIXenocideFeedback.kCornerTextureCoordinates.BottomRight))
