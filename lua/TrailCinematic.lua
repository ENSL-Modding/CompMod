...
function TrailCinematic:_CreateSegmentCinematic(index)
    ...
    local cinematicNamesNum = table.icount(self.cinematicNames)
    local cinematicNum = Clamp(math.ceil((index / self.numSegments) * cinematicNamesNum), 1, cinematicNamesNum)
...
function TrailCinematic:_TriggerFadeOutCinematic(index)
    ...
    local fadeOutCinematicNamesNum = table.icount(self.fadeOutCinematicNames)
    local cinematicNum = Clamp(math.ceil((index / self.numSegments) * fadeOutCinematicNamesNum), 1, fadeOutCinematicNamesNum)
