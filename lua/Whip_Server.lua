...
function Whip:BombardTarget(target)
    ...
    local nextSlapStartTime    = now + (kSlapAfterBombardTimeout    - kBombardAnimationHitTagAt)
    local nextBombardStartTime = now + (kBombardAfterBombardTimeout - kBombardAnimationHitTagAt)
