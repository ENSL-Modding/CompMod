...
function Shared.RegisterDecalMaterial(materialName)
    ...
    if not kSharedDecalMaterials[materialName] then
        kSharedDecalMaterials[#kSharedDecalMaterials + 1] = materialName
        kSharedDecalMaterials[materialName] = #kSharedDecalMaterials
        kNumSharedDecals = kNumSharedDecals + 1
    end
...
function GetDecalMaterialIndex(materialName)
    ...
    return kSharedDecalMaterials[materialName]
