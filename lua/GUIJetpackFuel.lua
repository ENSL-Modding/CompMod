...
function GUIJetpackFuel:Initialize()    
    ...
    self.background:SetTexturePixelCoordinates(GUIUnpackCoords(GUIJetpackFuel.kBgCoords))
    ...
    self.fuelBar:SetTexturePixelCoordinates(GUIUnpackCoords(GUIJetpackFuel.kBarCoords))
...
function GUIJetpackFuel:SetIsVisible(state)
...
function GUIJetpackFuel:GetIsVisible()
