...
local kNumberHealthColors = #kHealthColorsMarine
...
function GUIHealthCircle:Initialize()
    ...
    self.armorCircleStencil:SetTexturePixelCoordinates(GUIUnpackCoords(kArmorCircleStencilCoords))
    ...
    self.armorCircle:SetTexturePixelCoordinates(GUIUnpackCoords(kArmorCircleCoords))
