...
--
-- lua/menu2/widgets/GUIMenuButton.lua
--
...
class "GUIMenuButton" (baseClass)

GUIMenuButton:AddCompositeClassProperty("Label", "text", "Text")
...
function GUIMenuButton:Initialize(params, errorDepth)
    ...
    self.text:SetFont(MenuStyle.kButtonFont)
    ...
    self.glowyText:SetFont(MenuStyle.kButtonFont)
