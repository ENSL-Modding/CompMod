...
function GUINotificationItem:Initialize()
    ...
    self.background:SetTexturePixelCoordinates(GUIUnpackCoords(GUINotificationItem.kNotificationBgCoords))
    ...
    self.border:SetTexturePixelCoordinates(GUIUnpackCoords(GUINotificationItem.kNotificationBorderCoords))
    ...
    self.icon:SetTexturePixelCoordinates(GUIUnpackCoords(GetTextureCoordinatesForIcon(self.techId, self.useMarineStyle)))
...
function GUINotificationItem:GetNumChildren()
    return table.icount(self.children)
end
