...
function GUIStartVoteMenu:OnHelpScreenVisChange(state)
...
function GUIStartVoteMenu:SetIsVisible(state)
...
function GUIStartVoteMenu:UpdateVisibility()

    local visible = self.opened and not self.hiddenByHelpScreen
