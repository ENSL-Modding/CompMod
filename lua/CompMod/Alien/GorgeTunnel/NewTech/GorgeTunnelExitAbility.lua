...
function GorgeTunnelExitAbility:GetEnergyCost()
...
function GorgeTunnelExitAbility:ModifyCoords(coords, _, normal, player)

    PROFILE("GorgeTunnelExitAbility:ModifyCoords")
...
function GorgeTunnelExitAbility:GetIsPositionValid(position, player, surfaceNormal)
    ...
    PROFILE("GorgeTunnelExitAbility:GetIsPositionValid")
