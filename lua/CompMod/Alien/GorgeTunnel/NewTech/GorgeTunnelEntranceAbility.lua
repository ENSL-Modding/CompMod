...
function GorgeTunnelEntranceAbility:GetEnergyCost()
...
function GorgeTunnelEntranceAbility:ModifyCoords(coords, _, normal, player)

    PROFILE("GorgeTunnelEntranceAbility:ModifyCoords")
...
function GorgeTunnelEntranceAbility:GetIsPositionValid(position, player, surfaceNormal)
    ...
    PROFILE("GorgeTunnelEntranceAbility:GetIsPositionValid")
