function MarineTeam:InitTechTree()
    ...
    -- Weapon-specific
    self.techTree:AddTargetedBuyNode(kTechId.Shotgun,            kTechId.MunitionsTech,         kTechId.None)
    self.techTree:AddTargetedActivation(kTechId.DropShotgun,     kTechId.MunitionsTech,         kTechId.None)
