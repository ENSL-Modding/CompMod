...
function GUIPlayerRanking:Initialize()
    ...
    self.relativeSkillBackground:SetTexturePixelCoordinates(GUIUnpackCoords(kBarTexCoords))
    ...
    self.levelBackground:SetTexturePixelCoordinates(GUIUnpackCoords(kBarTexCoords))
...
function GUIPlayerRanking:Update(deltaTime)
    ...
    self.skillBar:SetTexturePixelCoordinates(GUIUnpackCoords(skillBarTexCoords))
    ...
    self.levelBar:SetTexturePixelCoordinates(GUIUnpackCoords(levelBarTexCoords))
