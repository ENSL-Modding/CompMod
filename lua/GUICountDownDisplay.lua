...
function GUICountDownDisplay:Initialize()
    ...
    self.marineIcon:SetTexturePixelCoordinates(GUIUnpackCoords(GUICountDownDisplay.kMarineIconTexCoords))
    ...
    self.alienIcon:SetTexturePixelCoordinates(GUIUnpackCoords(GUICountDownDisplay.kAlienIconTexCoords))
...
function GUICountDownDisplay:CreateTeamIcon()
    ...
    if PlayerUI_IsOnMarineTeam() then
        ...
        teamIcon:SetTexturePixelCoordinates(GUIUnpackCoords(GUICountDownDisplay.kMarineLogoTexCoords))
        
    else
    
        teamIcon:SetTexture(GUICountDownDisplay.kAlienLogoTexture)
        teamIcon:SetTexturePixelCoordinates(GUIUnpackCoords(GUICountDownDisplay.kAlienLogoTexCoords))
