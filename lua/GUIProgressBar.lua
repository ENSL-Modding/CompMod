...
function GUIProgressBar:Initialize()
    ...
    self.progressBarBg:SetTexturePixelCoordinates(GUIUnpackCoords(kBackgroundPixelCoords))
    ...
    self.progressBar:SetTexturePixelCoordinates(GUIUnpackCoords(kForegroundPixelCoords))
...
function GUIProgressBar:SetIsVisible(state)
    
    self.visible = state
    self.progressBarBg:SetIsVisible(state)
    
    if self.smokeyBackground then
        self.smokeyBackground:SetIsVisible(state)
    end
    
    if self.borderMask then
        self.borderMask:SetIsVisible(state)
    end
    
end

function GUIProgressBar:GetIsVisible()
...
function GUIProgressBar:Uninitialize()
    ...
    if self.borderMask then
        GUI.DestroyItem(self.borderMask)
        self.borderMask = nil
    end
...
function GUIProgressBar:InitCircleMask()
    ...
    self.borderMask:SetTexturePixelCoordinates(GUIUnpackCoords(kBackgroundPixelCoords))
    ...
    self.circle:SetTexturePixelCoordinates(GUIUnpackCoords(kBorderMaskPixelCoords))
