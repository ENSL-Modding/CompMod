...
local gHighlightButtonTechId
local gPosition, gTimePositionChanged
local gHighlightCinematic
local kHighlightCinematicName = PrecacheAsset("cinematics/hightlightworld.cinematic")

local gTimeNextEntry = 0

local gActiveEntry
local gNextForcedName
...
function CommanderTutorial_ResetAll()
    ...
    for teamNum = 0, 4 do
        local entries = gCommanderTutorialEntries[teamNum] or {}
