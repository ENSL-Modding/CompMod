...
function GUIWaitingForAutoTeamBalance:SetIsVisible(state)
...
function GUIWaitingForAutoTeamBalance:GetIsVisible()
...
function GUIWaitingForAutoTeamBalance:Update(deltaTime)
    self.waitingText:SetIsVisible(self.visible and PlayerUI_GetIsWaitingForTeamBalance())
end