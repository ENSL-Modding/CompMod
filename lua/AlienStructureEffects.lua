...
kAlienStructureEffects = 
{
    ...
    babbler_hatch_toxin =
    {
        babblerEggLandEffects =
        {
            {cinematic = "cinematics/alien/babbler/spawn_toxin.cinematic" },
            {sound = "", silenceupgrade = true, done = true},
            {sound = "sound/NS2.fev/alien/drifter/attack", world_space = true, done = true},
        },
    },
    ...
    bone_wall_burst = 
    {
        boneWallBurstEffect =
        {
            {sound = "sound/NS2.fev/alien/common/infestation_spikes" },
    ...
    clog_spawn =
    {
        ...
        {
            {parented_cinematic = "cinematics/alien/gorge/clog_spawn.cinematic"},
        } 
    },
    ...
    clog_spawn_toxin =
    {
        ...
        {
            {parented_cinematic = "cinematics/alien/gorge/clog_spawn_toxin.cinematic"},
        } 
    },
    ...
    clog_spawn_shadow =
    {
        clogSpawnEffects =
        {
            {parented_cinematic = "cinematics/alien/gorge/clog_spawn_shadow.cinematic"},
        } 
    },
    ...
    tunnel_building_pulse = 
    {
        tunnelBuildPulse = 
        {
            --{sound = "sound/NS2.fev/alien/common/regeneration", world_space = true},
            {sound = "sound/NS2.fev/alien/structures/tunnel/build", world_space = true},
        },
    },
    
    tunnel_ambient = 
    {
        tunnelUnbuiltAmbient = 
        {
            { parented_sound = "sound/NS2.fev/alien/structures/tunnel/loop_3D", world_space = true }
        },
    },

    tunnel_ambient_stop = 
    {
        tunnelUnbuiltAmbientStop = 
        {
            { stop_sound = "sound/NS2.fev/alien/structures/tunnel/loop_3D" }
        },
    }
}
