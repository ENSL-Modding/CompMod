...
function GUITipVideo:SetIsVisible(state)
...
function GUITipVideo:GetIsVisible()
...
function GUITipVideo:Update(dt)
    ...
    elseif self.state == "loadingHtml" then
        ...
        elseif self.videoWebView:GetUrlLoaded() then
            ...
            self.videoWebView:SetIsVisible(self.visible)
    ...
    elseif self.state == "playing" then
        ...
        if self:GetMustHide() then
            ...
            self.widget:SetIsVisible(self.visible)  -- set vis here rather than in loadingHtml, to avoid position-related flash
