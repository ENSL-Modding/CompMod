...
local function SetAnimTexPixCoords(animatedItem, animation)
    ...
    animatedItem.guiItem:SetTexturePixelCoordinates(GUIUnpackCoords(newCoords))
...
local function SetAnimTexCoords(animatedItem, animation)
    ...
    animatedItem.guiItem:SetTextureCoordinates(GUIUnpackCoords(newCoords))
...
local function SetTextureAnimation(animatedItem, animation)
    ...
    animatedItem.guiItem:SetTexturePixelCoordinates(GUIUnpackCoords(newTexPixelCoords))
...
function GUIAnimatedItem:GetIsAnimating()
    return table.icount(self.animations) > 0
end
