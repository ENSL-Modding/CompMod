...
function VoteManager:GetVotePassed()
    ...
    return table.icount(self.playersVoted) >= self:GetNumVotesNeeded()
...
function VoteManager:SetMinYesVoteNeeded(val)

    self.teamMinYesVoteOverride = val
