...
function GUIMinimapFrame:Update(deltaTime)
    ...
    local showMouse = self.visible and self.background:GetIsVisible() and isRespawning
    ...
    self.chooseSpawnText:SetIsVisible(self.visible and (not self.background:GetIsVisible() and isRespawning))
