...
local globalControlBindings = {
    ...
    "GrenadeQuickThrow", "input", Locale.ResolveString("BINDINGS_GRENADE_QUICK_THROW"), "B",
    ...
    "JoinMarines", "input", Locale.ResolveString("JOIN_MARINES"), "F5",
    "JoinAliens", "input", Locale.ResolveString("JOIN_ALIENS"), "F6",
    "JoinSpectate", "input", Locale.ResolveString("JOIN_SPECTATE"), "F7",
    ...
    "RequestStructure", "input", Locale.ResolveString("BINDINGS_REQUEST_STRUCTURE"), "None",
...
local globalComControlBindings = {
    ...
    "ToggleHealthBars", "input", Locale.ResolveString("COMBINDINGS_TOGGLE_HEALTHBARS"), "H",
}
