...
function GUIPoisonedFeedback:Initialize()
    ...
    bottomLeftCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIPoisonedFeedback.kCornerTextureCoordinates.BottomLeft))
    ...
    bottomRightCorner:SetTexturePixelCoordinates(GUIUnpackCoords(GUIPoisonedFeedback.kCornerTextureCoordinates.BottomRight))
...
function GUIPoisonedFeedback:SetIsVisible(state)
    
    self.visible = state
    
    self.corners.BottomLeft:SetIsVisible(state)
    self.corners.BottomRight:SetIsVisible(state)
    
end

function GUIPoisonedFeedback:GetIsVisible()
