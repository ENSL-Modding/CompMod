...
local function SharedUpdate(self)
    ...
    if Server and self:GetIsGhostStructure() then
        ...
        table.copy(GetEntitiesForTeamWithinRange("Babbler", GetEnemyTeamNumber(self:GetTeamNumber()), self:GetOrigin() + Vector(0, 0.3, 0), GhostStructureMixin.kGhostStructureCancelRange), enemies, true)
