...
{
    isMale = "boolean", --FIXME bigmac, this needs to be changed to marineType field
...
function BuildDamageMessage(targetEntityId, amount, hitpos)
...
function SendDamageMessage( attacker, targetEntityId, amount, point, overkill )

    if amount > 0 then

          local msg = BuildDamageMessage(targetEntityId, amount, point)
