...
local kSupplyIconTexture = PrecacheAsset("ui/hud2/team_info_atlas.dds")
local kMarineSupplyIconCoords = {50, 100, 100, 150}
local kAlienSupplyIconCoords = {0, 100, 50, 150}
...
function GUIInsight_TopBar:Initialize()
    ...
    alienBiomass = CreateIconTextItem(kTeam2Index, background, Vector(-GUIScale(-60),yoffset,0), kBuildMenuTexture, kBiomassIconCoords)
    ...
    marineSupply = CreateIconTextItem(kTeam1Index, background, -Vector(GUIScale(60),-yoffset,0), kSupplyIconTexture, kMarineSupplyIconCoords)
    alienSupply = CreateIconTextItem(kTeam2Index, background, Vector(-GUIScale(5),yoffset,0), kSupplyIconTexture, kAlienSupplyIconCoords)
